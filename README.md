...
- `bun run install:local-pi` explicitly hydrates the exact committed lockfile without lifecycle scripts, refreshes generated model data, builds, and globally links this checkout. The link operation does not resolve a registry package.
